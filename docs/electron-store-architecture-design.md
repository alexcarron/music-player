...
Encrypted at rest via Electron's `safeStorage`. Written after a successful OAuth exchange. Never sent to the renderer — all Spotify API calls happen in the main process.
## Renderer via IPC
