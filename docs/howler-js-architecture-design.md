...
# Preview Instance
The preview instance handles hover previews, the per-row preview button, and the preview keybind. It is short-lived — it is created fresh for each preview and destroyed when the preview ends.
